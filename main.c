...
int main(){
    ...
    printAllProcesses(processes_in_memory, num_of_processes);
    ...
    // //printf("Worst %d\n", wf_fragmentation);
    // printf("Best deallocation: %d, Worst: %d, first: %d, next: %d \n", bf_num_deallocations, wf_num_deallocations, ff_num_deallocations, nf_num_deallocations);
